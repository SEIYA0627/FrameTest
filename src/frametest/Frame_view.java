...
public class Frame_view extends Frame implements ActionListener,WindowListener{
	...
	private TextField text8 = new TextField("",10);
	private TextField text9 = new TextField("",10);
	private TextField text10 = new TextField("",10);
	private TextField text11 = new TextField("",10);
	private TextField text12 = new TextField("",10);
